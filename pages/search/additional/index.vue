    ...
    <div class='content'>
      <div class='subsection'>
        ...
        <div style='margin: 10px 0;'>
          ...
          <input type='text' v-model='takesoff'></input>
        </div>
        <div style='margin: 10px 0;'>
          <span class='confirm-destination'>Destination: </span>
          <input type='text' v-model='landsat'></input>
        </div>
        <div style='margin: 10px 0;'>
        ...
        <div>
          ...
          <input type='text' v-model='seat_price_lower' placeholder="100000"></input>
          to
          <input type='text' v-model='seat_price_upper' placeholder="200000"></input>
        </div>
        <br>
